...
connected to P2.18 pin is toggled, this is used to indicate whether the MCU is 
...
are generated, the RTC Alarm will wake-up the system. After that the P2.18 pin 
restarts toggling.
