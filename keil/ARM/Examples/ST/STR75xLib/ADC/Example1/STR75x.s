...
INV_MUL_MASK    EQU     ~0x18000000     ; Clock Multiplication Inverted     Mask
INV_DIV_MASK    EQU     ~0x0000001F     ; Clock Divider Inverted            Mask
...
;//       |1=| CK_RTC as CK_OSC source (not implemended in startup)
;//     |o1.19|       NCKDIE: No Clock detected interrupt Enable (not implemended in startup)
;//     |o1.17|       OSC4MOFF: OSC4M Oscillator Disable (not implemended in startup)
;//     |o1.16|       OSC4MBYP: OSC4M Oscillator Bypass Enable (not implemended in startup)
;//     |o1.6..7|     MCOS: Main clock Out selection (not implemended in startup)
;//       |0=| HCLK  |1=| PCLK  |2=| CK_OSC4M  |3=| CK_PLL2
;//     |o1.5|        MCOP: Main Clock Out Prescaler
;//       |0=| MCO is directly applied on MCO pin (not implemended in startup)
