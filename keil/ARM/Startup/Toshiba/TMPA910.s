;/*****************************************************************************/
;/* TMPA910.S: Startup file for Toshiba TMPA910 device series                 */
;/*****************************************************************************/
...
SMCCS2n_BASE    EQU     0xA0000000
SMCCS3n_BASE    EQU     0xE0000000
...
;  Static Memory Controller Setup ----------------------------------------------
                ...
                IF      (:LNOT::DEF:SMC_MPMC0_CS2_NO_INIT):LAND:(SMC_MPMC0_CS2_SETUP != 0)
                ...
                IF      (:LNOT::DEF:SMC_MPMC0_CS3_NO_INIT):LAND:(SMC_MPMC0_CS3_SETUP != 0)
