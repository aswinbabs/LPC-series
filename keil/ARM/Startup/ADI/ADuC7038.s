;/*****************************************************************************/
;/* STARTUP.S: Startup file for ADI ADuC703x device series                    */
;/*****************************************************************************/
...
Vectors         LDR     PC, Reset_Addr         
                ...
                LDR     PC, PAbt_Addr
                LDR     PC, DAbt_Addr
                DCD     0x27011970      ; Reserved Vector - Page 0 Checksum
                LDR     PC, IRQ_Addr
                LDR     PC, FIQ_Addr
...
CrcGet	
		...
		mov		r0,#0x0b
		str		r0,[r3,#Z_FEECON]
		ldr		r0,[r3,#Z_FEESIG]	;Read the signature.
		bx		lr			;		Return.

                AREA    |.ARM.__at_0x801FC|, CODE, READONLY
                DCD     0x16400000
