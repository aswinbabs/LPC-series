...
U16 cgi_func (U8 *env, U8 *buf, U16 buflen, U32 *pcgi) {
   ...
   switch (env[0]) {
      ...
      case 'm':         
         ...
         switch (env[2]) {
            case '1':
               len = sprintf((S8 *)buf,(const S8 *)&env[4],mems_data.outx_h);
               break;
            case '2':
               len = sprintf((S8 *)buf,(const S8 *)&env[4],mems_data.outx_l);
               break;
            case '3':
               len = sprintf((S8 *)buf,(const S8 *)&env[4],mems_data.outy_h);
               break;
            case '4':
               len = sprintf((S8 *)buf,(const S8 *)&env[4],mems_data.outy_l);
               break;
            case '5':
               len = sprintf((S8 *)buf,(const S8 *)&env[4],mems_data.outz_h);
               break;
            case '6':
               len = sprintf((S8 *)buf,(const S8 *)&env[4],mems_data.outz_l);
               break;
            case 'x':
               c = mems_data.outx_h;
               if (c > 100) c = 50+(256-c)*8;
                  else c = 50-c*8;
               len = sprintf((S8 *)buf,(const S8 *)&env[4],c);
               break;
            case 'y':
               c = mems_data.outy_h;
               if (c > 100) c = 50+(256-c)*8;
