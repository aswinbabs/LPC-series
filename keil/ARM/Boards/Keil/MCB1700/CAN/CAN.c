...
void CAN_IRQHandler (void)  {
  ...
  if (LPC_CAN1->GSR & (1 << 0)) {               /* CAN Controller #1 meassage is received */
  ...
  if (LPC_CAN2->GSR & (1 << 0)) {                /* CAN Controller #2 meassage is received */
  ...
  if (LPC_CAN1->GSR & (1 << 3)) {                /* CAN Controller #1 meassage is transmitted */
	CAN_TxRdy[0] = 1; 
  }

  if (LPC_CAN2->GSR & (1 << 3)) {                /* CAN Controller #2 meassage is transmitted */
	CAN_TxRdy[1] = 1; 
  }
