...
;//                     <1=> 2 Wait states
;//                     <2=> 3 Wait states
;//   <o7.10> PWD: Power-down configuration    
;//     <i> Default: Enabled 
;//                     <0=> Disabled  
;//                     <1=> Enabled
;//   <o7.9> LVDEN: Low Voltage Detector enable
;//     <i> Default: Enabled 
;//                     <0=> Enabled   
;//                     <1=> Disabled
;//   <o7.4> BUSCFG: Flash bus clock configuration
...
FLASH_CFG_Val   EQU     0x00001010


; System Control Unit (SCU) definitions
SCU_BASE        EQU     0x5C002400      ; SCU Base Address (non-buffered)
...
CLOCK_SETUP     EQU     1
SCU_CLKCNTR_Val EQU     0x00031004
SCU_PLLCONF_Val EQU     0x000AC019
SCU_PCGR0_Val   EQU     0x000009FB
SCU_PCGR1_Val   EQU     0x00ECC801
