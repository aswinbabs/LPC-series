...
/* LED Definitions */
#define LED_MSK         0x0000FF00  /* P2.8..15 */
#define LED_RD          0x00000100  /* P2.8 */
#define LED_WR          0x00000200  /* P2.9 */
#define LED_CFG         0x00000400  /* P2.10 */
#define LED_SUSP        0x00000800  /* P2.11 */
