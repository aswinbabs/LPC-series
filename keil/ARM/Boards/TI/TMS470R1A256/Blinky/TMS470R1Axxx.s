;/*****************************************************************************/
;/* TMS470R1Axxx.S: Startup file for Texas Instruments TMS470R1Axxx device    */
;/*****************************************************************************/
...
;/*
; *  The TMS470R1Axxx.S code is executed after CPU Reset. This file may be 
...
; *
; *  SYS_MODE:   when set the startup code leaves processor in System Mode.
; */
...
;// </e>
CLOCK_SETUP     EQU     1
GLBCTRL_Val     EQU     0x00000008
PCR_Val         EQU     0x0000001F
...
; Area Definition for Protection Keys
                ...
                AREA    |.ARM.__AT_0x1FE0|, CODE, READONLY
                ARM
...
;  Enter User/System Mode and set its Stack Pointer
                IF      :DEF:SYS_MODE
                MSR     CPSR_c, #Mode_SYS
                ELSE
                MSR     CPSR_c, #Mode_USR
