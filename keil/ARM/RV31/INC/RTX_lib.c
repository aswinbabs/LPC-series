...
/*----------------------------------------------------------------------------
 *      Tick Timer configuration for ARM7/9
 *---------------------------------------------------------------------------*/
...
#pragma O0
/* Export following defines to uVision debugger. */
U8  const os_time_sl = OS_TIME_SL;
U32 const os_treload = OS_TRV;
#pragma pop
