...
//
//*****************************************************************************
#define USB_HOST_PWRFLT_LOW     0x00000000
#define USB_HOST_PWRFLT_HIGH    0x00000020
...
//
//*****************************************************************************
#define USB_FIFO_SZ_TO_BYTES(x) ((8 << ((x) & ~ 0x00000010)) * \
                                 (((x) & 0x00000010) ? 2 : 1))
...
extern void USBHostEndpointIntClear(unsigned long ulBase,
                                    unsigned long ulEndpoint,
                                    unsigned long ulFlags);
