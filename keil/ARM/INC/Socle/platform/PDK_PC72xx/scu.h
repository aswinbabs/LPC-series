...
extern int socle_get_cpu_clock (void);		//return CPU clock (Hz)
extern int socle_get_ahb_clock (void);		//return AHB clock (Hz)
extern int socle_get_apb_clock (void);		//return APB clock (Hz)
extern int socle_get_uart_clock (void);		//return UART clock (Hz)
