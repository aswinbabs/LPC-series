...
#define UHC_REG_BASE		SOCLE_AHB0_UHC
#define UHC_INT			SOCLE_INTC_UHC	

#define   CapReg						(UHC_REG_BASE + 0x100)
//#define   CapReg						0x180a4100	/*0x1e6e0100*/
	#define   CAPLENGTH					(CapReg + 0x00)
	/*0x01 Reserved*/
	#define   HCIVERSION					(CapReg + 0x02)
	#define   HCSPARAMS					(CapReg + 0x04)
		#define 	HCS_DEBUG_PORT			((readw(HCSPARAMS)>>20)&0xf)	/* bits 23:20, debug port? */
	...
	#define   HCSP_PORTROUTE			(CapReg + 0x0C)
/*-------------------------------------------------------------------------*/
/* Operational Register Define */
/*-------------------------------------------------------------------------*/
#define   OperReg						(UHC_REG_BASE + 0x120)
//#define   OperReg						0x1e6e0120
	#define   USBCMD						(OperReg + 0x00)
		/* 23:16 is r/w intr rate, in microframes; default "8" == 1/msec */
		#define 	CMD_PARK					(1<<11)		/* enable "park" on async qh */
		#define 	CMD_PARK_CNT				(((USBCMD)>>8)&3)	/* how many transfers to park for */
	...
	#define   USBINTR					(OperReg + 0x08)
	#define   FRINDEX					(OperReg + 0x0C)
	#define   CTRLDSSEGMENT				(OperReg + 0x10)
	#define   PERIODICLISTBASE			(OperReg + 0x14)
	#define   ASYNCICLISTADDR			(OperReg + 0x18)
	/*1C ~ 3F Reserved*/
	#define   CONFIGFLAG					(OperReg + 0x40)
		#define 	FLAG_CF					(1<<0)		/* true: we'll support "high speed" */
	#define   PORTSC						(OperReg + 0x44)
		/* 31:23 reserved */
		...
		#define 	PORT_USB11 				(((PORTSC)&(3<<10))==(1<<10))	/* for USB 1.1 device */
