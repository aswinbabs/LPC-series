 ...
 * 
 *  SmartFusion A2FM3Fxx Cortex Microcontroller Software Interface - Peripheral
 *  Access Layer.
 *
 *  This file describes the interrupt assignment and peripheral registers for
 *  the SmartFusion A2FM3Fxx familly of devices. 
 *
 * SVN $Revision: 1197 $
 * SVN $Date: 2009-07-30 16:14:22 +0100 (Thu, 30 Jul 2009) $
 */
#ifndef __A2FM3FXXX_H__
#define __A2FM3FXXX_H__
/*
 * ==========================================================================
...
/******  SmartFusion specific Interrupt Numbers *********************************************************/
  ...
  HINT0_IRQn                      = 7,        /*!< eNVM0 operation completion interrupt                 */
  HINT1_IRQn                      = 8,        /*!< eNVM1 operation completion interrupt                 */
  ...
  F2H_IRQn                        = 31,       /*!< FPGA fabric interrupt                                */
...
#include "system_A2FM3Fxxx.h"                 /* SmartFusion System                                 */
...
typedef struct
{
    ...
    __IO uint32_t FCR_RXDRY_TXRDYN_EN;
...
typedef struct
{
    ...
    __IO uint32_t CONFIG_4;
    __IO uint32_t CONFIG_5;
    __IO uint32_t CONFIG_6;
    __IO uint32_t CONFIG_7;
    __IO uint32_t CONFIG_8;
    __IO uint32_t CONFIG_9;
    __IO uint32_t CONFIG_10;
    __IO uint32_t CONFIG_11;
    __IO uint32_t CONFIG_12;
    __IO uint32_t CONFIG_13;
    __IO uint32_t CONFIG_14;
    __IO uint32_t CONFIG_15;
    __IO uint32_t CONFIG_16;
    __IO uint32_t CONFIG_17;
    __IO uint32_t CONFIG_18;
    __IO uint32_t CONFIG_19;
    __IO uint32_t CONFIG_20;
    __IO uint32_t CONFIG_21;
    __IO uint32_t CONFIG_22;
    __IO uint32_t CONFIG_23;
    __IO uint32_t CONFIG_24;
    __IO uint32_t CONFIG_25;
    __IO uint32_t CONFIG_26;
    __IO uint32_t CONFIG_27;
    __IO uint32_t CONFIG_28;
    __IO uint32_t CONFIG_29;
    __IO uint32_t CONFIG_30;
    __IO uint32_t CONFIG_31;
    __IO uint32_t INTR;
    __I  uint32_t GPIN;
    __IO uint32_t GPOUT;
} GPIO_TypeDef;
...
typedef struct
{
    ...
    __I  uint32_t TIM64VALUEU;
    __I  uint32_t TIM64VALUEL;
    __IO uint32_t TIM64LOADVALUEU;
    __IO uint32_t TIM64LOADVALUEL;
    __IO uint32_t TIM64BGLOADVALUEU;
    __IO uint32_t TIM64BGLOADVALUEL;
...
/*    
    __IO uint32_t CHANNEL_0_CRTL;
    __IO uint32_t CHANNEL_0_STATUS;
    __IO uint32_t CHANNEL_0_BUFFER_A_SRC_ADDR;
    __IO uint32_t CHANNEL_0_BUFFER_A_DEST_ADDR;
    __IO uint32_t CHANNEL_0_BUFFER_A_TRANSFER_COUNT;
    __IO uint32_t CHANNEL_0_BUFFER_B_SRC_ADDR;
    __IO uint32_t CHANNEL_0_BUFFER_B_DEST_ADDR;
    __IO uint32_t CHANNEL_0_BUFFER_B_TRANSFER_COUNT;

    __IO uint32_t CHANNEL_1_CRTL;
    __IO uint32_t CHANNEL_1_STATUS;
    __IO uint32_t CHANNEL_1_BUFFER_A_SRC_ADDR;
    __IO uint32_t CHANNEL_1_BUFFER_A_DEST_ADDR;
    __IO uint32_t CHANNEL_1_BUFFER_A_TRANSFER_COUNT;
    __IO uint32_t CHANNEL_1_BUFFER_B_SRC_ADDR;
    __IO uint32_t CHANNEL_1_BUFFER_B_DEST_ADDR;
    __IO uint32_t CHANNEL_1_BUFFER_B_TRANSFER_COUNT;

    __IO uint32_t CHANNEL_2_CRTL;
    __IO uint32_t CHANNEL_2_STATUS;
    __IO uint32_t CHANNEL_2_BUFFER_A_SRC_ADDR;
    __IO uint32_t CHANNEL_2_BUFFER_A_DEST_ADDR;
    __IO uint32_t CHANNEL_2_BUFFER_A_TRANSFER_COUNT;
    __IO uint32_t CHANNEL_2_BUFFER_B_SRC_ADDR;
    __IO uint32_t CHANNEL_2_BUFFER_B_DEST_ADDR;
    __IO uint32_t CHANNEL_2_BUFFER_B_TRANSFER_COUNT;

    __IO uint32_t CHANNEL_3_CRTL;
    __IO uint32_t CHANNEL_3_STATUS;
    __IO uint32_t CHANNEL_3_BUFFER_A_SRC_ADDR;
    __IO uint32_t CHANNEL_3_BUFFER_A_DEST_ADDR;
    __IO uint32_t CHANNEL_3_BUFFER_A_TRANSFER_COUNT;
    __IO uint32_t CHANNEL_3_BUFFER_B_SRC_ADDR;
    __IO uint32_t CHANNEL_3_BUFFER_B_DEST_ADDR;
    __IO uint32_t CHANNEL_3_BUFFER_B_TRANSFER_COUNT;

    __IO uint32_t CHANNEL_4_CRTL;
    __IO uint32_t CHANNEL_4_STATUS;
    __IO uint32_t CHANNEL_4_BUFFER_A_SRC_ADDR;
    __IO uint32_t CHANNEL_4_BUFFER_A_DEST_ADDR;
    __IO uint32_t CHANNEL_4_BUFFER_A_TRANSFER_COUNT;
    __IO uint32_t CHANNEL_4_BUFFER_B_SRC_ADDR;
    __IO uint32_t CHANNEL_4_BUFFER_B_DEST_ADDR;
    __IO uint32_t CHANNEL_4_BUFFER_B_TRANSFER_COUNT;

    __IO uint32_t CHANNEL_5_CRTL;
    __IO uint32_t CHANNEL_5_STATUS;
    __IO uint32_t CHANNEL_5_BUFFER_A_SRC_ADDR;
    __IO uint32_t CHANNEL_5_BUFFER_A_DEST_ADDR;
    __IO uint32_t CHANNEL_5_BUFFER_A_TRANSFER_COUNT;
    __IO uint32_t CHANNEL_5_BUFFER_B_SRC_ADDR;
    __IO uint32_t CHANNEL_5_BUFFER_B_DEST_ADDR;
    __IO uint32_t CHANNEL_5_BUFFER_B_TRANSFER_COUNT;

    __IO uint32_t CHANNEL_6_CRTL;
    __IO uint32_t CHANNEL_6_STATUS;
    __IO uint32_t CHANNEL_6_BUFFER_A_SRC_ADDR;
    __IO uint32_t CHANNEL_6_BUFFER_A_DEST_ADDR;
    __IO uint32_t CHANNEL_6_BUFFER_A_TRANSFER_COUNT;
    __IO uint32_t CHANNEL_6_BUFFER_B_SRC_ADDR;
    __IO uint32_t CHANNEL_6_BUFFER_B_DEST_ADDR;
    __IO uint32_t CHANNEL_6_BUFFER_B_TRANSFER_COUNT;

    __IO uint32_t CHANNEL_7_CRTL;
    __IO uint32_t CHANNEL_7_STATUS;
    __IO uint32_t CHANNEL_7_BUFFER_A_SRC_ADDR;
    __IO uint32_t CHANNEL_7_BUFFER_A_DEST_ADDR;
    __IO uint32_t CHANNEL_7_BUFFER_A_TRANSFER_COUNT;
    __IO uint32_t CHANNEL_7_BUFFER_B_SRC_ADDR;
    __IO uint32_t CHANNEL_7_BUFFER_B_DEST_ADDR;
    __IO uint32_t CHANNEL_7_BUFFER_B_TRANSFER_COUNT;
*/    
} PDMA_TypeDef;
...
typedef struct
{
    __IO uint32_t H2F_IRQ_ENABLE0;
    __IO uint32_t H2F_IRQ_ENABLE1;
    __IO uint32_t H2F_IRQ_ENABLE2;
    __IO uint32_t H2F_IRQ_ENABLE3;
    __IO uint32_t H2F_IRQ_ENABLE4;
    __IO uint32_t H2F_IRQ_ENABLE5;
    __IO uint32_t H2F_IRQ_ENABLE6;
    __IO uint32_t H2F_IRQ_ENABLE7;
    __I  uint32_t H2F_IRQ_REASON0;
    __I  uint32_t H2F_IRQ_REASON1;
    __I  uint32_t H2F_IRQ_REASON2;
    __I  uint32_t H2F_IRQ_REASON3;
    __I  uint32_t H2F_IRQ_REASON4;
    __I  uint32_t H2F_IRQ_REASON5;
    __I  uint32_t H2F_IRQ_REASON6;
    __I  uint32_t H2F_IRQ_REASON7;
    __IO uint32_t H2F_IRQ_MODE;
} H2F_IRQ_CTRL_TypeDef;
...
typedef struct
{
    __IO uint32_t ESRAM_CONFIG;
    __IO uint32_t ENVM_CONFIG;
    __IO uint32_t ENVM_REMAP_BASE;
    __IO uint32_t ENVM_FAB_REMAP;
    __IO uint32_t FAB_PROT_SIZE;
    __IO uint32_t FAB_PROT_BASE;
    __IO uint32_t MATRIX_CONFIG;
    __IO uint32_t DSS_STATUS;
    __IO uint32_t CLR_DSS_STATUS;
    __IO uint32_t FROM_CONFIG;
    __IO uint32_t IAP_CONFIG;
    __IO uint32_t SOFT_INTERRUPT;
    __IO uint32_t SOFT_RESET;
    __IO uint32_t DEVICE_STATUS;
    __IO uint32_t SYSTICK_CONFIG;
    __IO uint32_t EM_MUX_CONFIG;
    __IO uint32_t EM_CONFIG_0;
    __IO uint32_t EM_CONFIG_1;
    __IO uint32_t CLK_CTRL;
    __IO uint32_t CCC_DIV_CONFIG;
    __IO uint32_t CCC_MUX_CONFIG;
    __IO uint32_t CCC_PLL_CONFIG;
    __IO uint32_t CCC_DLY_CONFIG;
    __IO uint32_t CCC_STATUS;
    __IO uint32_t OSC_CTRL;
    __IO uint32_t VTG_CTRL;
    __IO uint32_t SPARE;
    __IO uint32_t FAB_IF;
    __IO uint32_t APB_EXTN;
    __IO uint32_t LOOPBACK_CTRL;
    __IO uint32_t IO_BANK_CONFIG;
    __IO uint32_t GPIN_SRC_SEL;
    __IO uint32_t TEST_STATUS;
    ...
    __IO uint32_t FPGA_CTRL;
         uint32_t RESERVED[24];
    __IO uint32_t IOMUXCELL_CONFIG[83];
} SYSREG_TypeDef;
...
#define H2F_IRQ_CTRL            ((H2F_IRQ_CTRL_TypeDef  *) H2F_IRQ_CTRL_BASE          )
